...
flare. It keeps the normal Vulkan surface, swapchain, tracer, denoiser, composition, and
post-processing path active in a hidden 1280x720 logical-pixel window. The report records the actual
physical render extent (for example, 2560x1440 on a 2x Retina display).
...
validate the metric math and CLI contract.
