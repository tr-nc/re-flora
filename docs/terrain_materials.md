...
| --- | --- | --- |
| Procedural Terrain Material | on | Off restores the stable palette exactly. |
...
The one skip is the repository's pre-existing saved PATT fixture exception, not a new material
exemption. The material shader test checks determinism, seed sensitivity, adjacent values, a
...
### Measured first-stage result (2026-09-06)
...
### Final runtime gates and candidate status
