...
- [ ] Finish surface construction: 2 remaining entry points.
...
| Production source layout | All 69 accepted modules and entries live under `shader/slang/`; runtime logical paths remain unchanged | Keep native production sources in this root as families migrate |
...
10. **Complete surface construction**: dense and sparse extraction, both indirect-dispatch preparation passes, occupancy clearing/editing/restoration, and flora growth updates are native. Port the two remaining flora-output entry points, reusing their accepted extraction, flora, occupancy, placement, layout, and solid-workgroup modules.
