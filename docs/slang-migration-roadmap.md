...
- [ ] Finish surface construction: 6 remaining entry points.
...
| Production source layout | All 58 accepted modules and entries live under `shader/slang/`; runtime logical paths remain unchanged | Keep native production sources in this root as families migrate |
...
10. **Complete surface construction**: dense and sparse extraction, indirect-dispatch preparation, and occupancy clearing are native. Port the six remaining surface entry points, reusing their accepted extraction, layout, and solid-workgroup modules.
