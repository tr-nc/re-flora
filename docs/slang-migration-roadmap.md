...
- [ ] Finish surface construction: 7 remaining entry points.
...
| Production source layout | All 57 accepted modules and entries live under `shader/slang/`; runtime logical paths remain unchanged | Keep native production sources in this root as families migrate |
...
10. **Complete surface construction**: dense and sparse extraction plus indirect-dispatch preparation are native. Port the seven remaining surface entry points, reusing their accepted extraction, layout, and solid-workgroup modules.
