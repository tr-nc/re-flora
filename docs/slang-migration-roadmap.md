...
- [ ] Finish surface construction: 3 remaining entry points.
...
| Production source layout | All 65 accepted modules and entries live under `shader/slang/`; runtime logical paths remain unchanged | Keep native production sources in this root as families migrate |
...
10. **Complete surface construction**: dense and sparse extraction, both indirect-dispatch preparation passes, occupancy clearing and restoration, and flora growth updates are native. Port the three remaining surface entry points, reusing their accepted extraction, flora, occupancy, layout, and solid-workgroup modules.
