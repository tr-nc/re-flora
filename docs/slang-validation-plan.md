...
- All decisive Phase 2 shader candidates now have native implementations. The next gate is an explicit adoption-risk reassessment before family-wide migration. Exact compiler pinning, broader native-Vulkan performance coverage, and cross-platform CI remain open.
