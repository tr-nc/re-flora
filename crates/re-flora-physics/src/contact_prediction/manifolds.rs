...
// Derived from Dimforge Parry 0.29.0, contact_manifolds_voxels_shape.rs.
// See README.md in this directory for upstream provenance and local adaptations.
// The contact algorithm, canonical voxel state, and manifold cache remain Parry's.

use rapier3d::parry::bounding_volume::{Aabb, BoundingVolume};
use rapier3d::parry::math::{IVector, IVectorExt, Int, Pose, Real, Vector, VectorExt, DIM};
use rapier3d::parry::query::{
    ContactManifold, ContactManifoldsWorkspace, PersistentQueryDispatcher, PointQuery,
    TypedWorkspaceData, WorkspaceData,
};
use rapier3d::parry::shape::{AxisMask, Cuboid, Shape, SupportMap, VoxelData, VoxelType, Voxels};
use rapier3d::parry::utils::PoseOpt;
    ...
    ContactData: Default + Copy,
{
    ...
    // Upstream d299cdca: enumerate speculative contacts within the prediction distance,
    // including the contact skin supplied by Rapier, before testing the actual surfaces.
