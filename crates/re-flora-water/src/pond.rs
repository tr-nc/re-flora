...
pub struct PondWaterSim {
    ...
    pub(crate) cell_density_smoothed_counts: Vec<f32>,
    pub(crate) cell_density_smoothed_position_sums: Vec<Vec3>,
...
impl PondWaterSim {
    pub fn new(config: PondWaterConfig) -> Self {
        ...
        let mut sim = Self {
            ...
            cell_density_smoothed_counts: Vec::new(),
            cell_density_smoothed_position_sums: Vec::new(),
