...
class ParsePerfLogTests(unittest.TestCase):
    def parse_fixture(self):
        return parse_perf_log.parse_log_lines(
            [
                ...
                "[12:00:00 INFO verdarium_water::mls_mpm] [PERF][WATER] particles 10000 grid UVec3(160, 64, 160) nodes 1638400 substeps 12 total 42.00ms avg 3.500ms/substep repair 0.00ms clear 0.40ms p2g 12.00ms grid 1.20ms grid_update 1.10ms g2p 28.00ms g2p_gather 5.00ms g2p_box 1.00ms g2p_terrain 2.00ms g2p_repair 0.50ms diagnostics 0.20ms residual 0.10ms shadow_measure 0.30ms p2g_density_corr/substep 10.5 p2g_density_corr_factor_avg 1.125 p2g_density_corr_factor_max 1.750 terrain_cache_skips/substep 120 terrain_cache_projections/substep 30 terrain_exact_fallbacks/substep 4 terrain_exact_checks/substep 5 terrain_exact_corrections/substep 2 terrain_shadow_samples/substep 25.5 terrain_shadow_false_skips 1 terrain_shadow_sdf_err_avg 0.01234 terrain_shadow_sdf_err_max 0.05678 active_nodes/substep 900 particle_y 0.100..1.200 avg 0.400 terrain_sdf_min -0.0100 penetrating 3 no_sdf 7",
    ...
    def test_latest_log_prefers_pointer_file(self):
        with tempfile.TemporaryDirectory() as tmp_dir_name:
            ...
            older = tmp_dir / "verdarium-old.log"
            newer = tmp_dir / "verdarium-new.log"
            pointed = tmp_dir / "verdarium-pointed.log"
