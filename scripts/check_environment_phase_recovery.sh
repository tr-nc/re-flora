...
run_root="${RE_FLORA_ENVIRONMENT_PHASE_RECOVERY_RUN_ROOT:-$repo_root/target/environment-phase-recovery}"
latest_pointer="${RE_FLORA_ENVIRONMENT_PHASE_RECOVERY_LATEST_POINTER:-$repo_root/target/re-flora-logs/latest-run-log.txt}"
cases=(
    "sealed:Static"
