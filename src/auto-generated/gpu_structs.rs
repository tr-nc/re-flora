...
pub struct GuiInput {
    ...
    pub leaf_paddle_amplitude_wind_min_strength: f32,
    pub leaf_paddle_amplitude_wind_max_strength: f32,
    pub leaf_paddle_amplitude_wind_curve_power: f32,
    pub leaf_paddle_frequency_wind_min_strength: f32,
    pub leaf_paddle_frequency_wind_max_strength: f32,
    pub leaf_paddle_frequency_wind_curve_power: f32,
