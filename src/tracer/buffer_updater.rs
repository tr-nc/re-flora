...
impl BufferUpdater {
    ...
    pub fn update_gui_input(
        ...
        leaf_paddle_amplitude_wind_min_strength: f32,
        leaf_paddle_amplitude_wind_max_strength: f32,
        leaf_paddle_amplitude_wind_curve_power: f32,
        leaf_paddle_frequency_wind_min_strength: f32,
        leaf_paddle_frequency_wind_max_strength: f32,
        leaf_paddle_frequency_wind_curve_power: f32,
