...
impl BufferUpdater {
    ...
    pub fn update_gui_input(
        ...
        resources.uniforms.gui_input.fill_uniform(&GuiInput {
            ...
            legacy_environment_lighting: legacy_environment_lighting as u32,
            legacy_terrain_indirect_lighting: legacy_terrain_indirect_lighting as u32,
            legacy_ambient_light: legacy_ambient_light.to_array(),
