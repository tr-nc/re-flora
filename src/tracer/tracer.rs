...
impl Tracer {
    pub fn new(
        ...
        this_self.initialize_uniforms(visible_chunk_dim);
    ...
    fn initialize_uniforms(&self, visible_chunk_dim: UVec3) {
        let scene_info_data = BufferBuilder::from_struct_buffer(&self.resources.scene_info)
            .unwrap()
