...
pub static GENERATED_GUI_PARAMS: &[GeneratedGuiParamDescriptor] = &[
    ...
    GeneratedGuiParamDescriptor {
        section: "Shadow",
        id: "terrain_ray_origin_offset_world",
        kind: "float",
        label: "Terrain Ray Origin Offset (world)",
    },
    GeneratedGuiParamDescriptor {
        section: "Shadow",
    ...
    GeneratedGuiParamDescriptor {
        section: "Shadow",
        id: "ddgi_history_retention",
        kind: "float",
        label: "DDGI History Retention",
    },
    GeneratedGuiParamDescriptor {
        section: "Shadow",
        id: "vsm_blur_radius",
    ...
    GeneratedGuiParamDescriptor {
        section: "Kochia",
        id: "kochia_bottom_diameter_voxels",
        kind: "float",
        label: "Bottom Diameter (voxels)",
    },
    GeneratedGuiParamDescriptor {
        section: "Kochia",
        id: "kochia_waist_diameter_voxels",
        kind: "float",
        label: "Waist Diameter (voxels)",
    },
    GeneratedGuiParamDescriptor {
        section: "Kochia",
        id: "kochia_top_diameter_voxels",
        kind: "float",
        label: "Top Diameter (voxels)",
    },
    GeneratedGuiParamDescriptor {
        section: "Kochia",
        id: "kochia_waist_height",
        kind: "float",
        label: "Waist Height",
    },
    GeneratedGuiParamDescriptor {
    ...
    GeneratedGuiParamDescriptor {
        ...
        kind: "bool",
        label: "Procedural Terrain Material",
    },
    GeneratedGuiParamDescriptor {
        section: "Terrain Material",
        id: "terrain_soil_scale_voxels",
        kind: "float",
        label: "Soil Mottling Scale (voxels)",
    },
    GeneratedGuiParamDescriptor {
        section: "Terrain Material",
        id: "terrain_soil_strength",
        kind: "float",
        label: "Soil Mottling Strength",
    },
    GeneratedGuiParamDescriptor {
        section: "Terrain Material",
        id: "terrain_rock_scale_voxels",
        kind: "float",
        label: "Rock Layer Spacing (voxels)",
    },
    GeneratedGuiParamDescriptor {
        section: "Terrain Material",
        id: "terrain_rock_strength",
        kind: "float",
        label: "Rock Layer Strength",
    },
    GeneratedGuiParamDescriptor {
        section: "Terrain Material",
        id: "terrain_rock_layer_tilt",
        kind: "float",
        label: "Rock Layer Tilt (deg, world XY)",
    },
    GeneratedGuiParamDescriptor {
        section: "Terrain Material",
    ...
    GeneratedGuiParamDescriptor {
        section: "Terrain Material",
        id: "terrain_material_seed",
        kind: "uint",
        label: "Terrain Pattern Seed",
    },
    GeneratedGuiParamDescriptor {
        section: "HeadBob",
...
pub struct GuiAdjustables {
    ...
    pub ddgi_history_retention: crate::gui_adjustables::FloatParam,
    ...
    pub kochia_color_a: crate::gui_adjustables::ColorParam,
    pub kochia_color_b: crate::gui_adjustables::ColorParam,
    pub kochia_bottom_diameter_voxels: crate::gui_adjustables::FloatParam,
    pub kochia_waist_diameter_voxels: crate::gui_adjustables::FloatParam,
    pub kochia_top_diameter_voxels: crate::gui_adjustables::FloatParam,
    pub kochia_waist_height: crate::gui_adjustables::FloatParam,
    ...
    pub terrain_soil_scale_voxels: crate::gui_adjustables::FloatParam,
    pub terrain_soil_strength: crate::gui_adjustables::FloatParam,
    pub terrain_rock_scale_voxels: crate::gui_adjustables::FloatParam,
    pub terrain_rock_strength: crate::gui_adjustables::FloatParam,
    pub terrain_rock_layer_tilt: crate::gui_adjustables::FloatParam,
...
impl GuiAdjustables {
    pub fn from_config(config: &crate::app::gui_config_model::GuiConfigFile) -> Self {
        ...
        let mut ddgi_history_retention_field: Option<crate::gui_adjustables::FloatParam> = None;
        ...
        let mut kochia_color_a_field: Option<crate::gui_adjustables::ColorParam> = None;
        let mut kochia_color_b_field: Option<crate::gui_adjustables::ColorParam> = None;
        let mut kochia_bottom_diameter_voxels_field: Option<crate::gui_adjustables::FloatParam> = None;
        let mut kochia_waist_diameter_voxels_field: Option<crate::gui_adjustables::FloatParam> = None;
        let mut kochia_top_diameter_voxels_field: Option<crate::gui_adjustables::FloatParam> = None;
        let mut kochia_waist_height_field: Option<crate::gui_adjustables::FloatParam> = None;
        ...
        let mut terrain_soil_scale_voxels_field: Option<crate::gui_adjustables::FloatParam> = None;
        let mut terrain_soil_strength_field: Option<crate::gui_adjustables::FloatParam> = None;
        let mut terrain_rock_scale_voxels_field: Option<crate::gui_adjustables::FloatParam> = None;
        let mut terrain_rock_strength_field: Option<crate::gui_adjustables::FloatParam> = None;
        let mut terrain_rock_layer_tilt_field: Option<crate::gui_adjustables::FloatParam> = None;
                ...
                match param.id.as_str() {
                    ...
                    "ddgi_history_retention" => {
                        if let (GuiParamKind::Float, GuiParamValue::Float { value, min, max }) = (&param.kind, &param.value) {
                            let min = min.unwrap_or(0.0);
                            let max = max.unwrap_or(1.0);
                            ddgi_history_retention_field = Some(crate::gui_adjustables::FloatParam::new(*value, min..=max));
                        }
                    }
                    "vsm_blur_radius" => {
                        if let (GuiParamKind::Uint, GuiParamValue::Uint { value, min, max }) = (&param.kind, &param.value) {
                    ...
                    "kochia_color_a" => {
                        if let (GuiParamKind::Color, GuiParamValue::Color { value }) = (&param.kind, &param.value) {
                            kochia_color_a_field = Some(crate::gui_adjustables::ColorParam::new(crate::app::gui_config::parse_color(value)));
                        }
                    }
                    "kochia_color_b" => {
                        if let (GuiParamKind::Color, GuiParamValue::Color { value }) = (&param.kind, &param.value) {
                            kochia_color_b_field = Some(crate::gui_adjustables::ColorParam::new(crate::app::gui_config::parse_color(value)));
                        }
                    }
                    "kochia_bottom_diameter_voxels" => {
                        if let (GuiParamKind::Float, GuiParamValue::Float { value, min, max }) = (&param.kind, &param.value) {
                            let min = min.unwrap_or(0.0);
                            let max = max.unwrap_or(1.0);
                            kochia_bottom_diameter_voxels_field = Some(crate::gui_adjustables::FloatParam::new(*value, min..=max));
                        }
                    }
                    "kochia_waist_diameter_voxels" => {
                        if let (GuiParamKind::Float, GuiParamValue::Float { value, min, max }) = (&param.kind, &param.value) {
                            let min = min.unwrap_or(0.0);
                            let max = max.unwrap_or(1.0);
                            kochia_waist_diameter_voxels_field = Some(crate::gui_adjustables::FloatParam::new(*value, min..=max));
                        }
                    }
                    "kochia_top_diameter_voxels" => {
                        if let (GuiParamKind::Float, GuiParamValue::Float { value, min, max }) = (&param.kind, &param.value) {
                            let min = min.unwrap_or(0.0);
                            let max = max.unwrap_or(1.0);
                            kochia_top_diameter_voxels_field = Some(crate::gui_adjustables::FloatParam::new(*value, min..=max));
                        }
                    }
                    "kochia_waist_height" => {
                        if let (GuiParamKind::Float, GuiParamValue::Float { value, min, max }) = (&param.kind, &param.value) {
                            let min = min.unwrap_or(0.0);
                            let max = max.unwrap_or(1.0);
                            kochia_waist_height_field = Some(crate::gui_adjustables::FloatParam::new(*value, min..=max));
                        }
                    }
                    ...
                    "leaf_transmission_strength" => {
                        if let (GuiParamKind::Float, GuiParamValue::Float { value, min, max }) = (&param.kind, &param.value) {
                            let min = min.unwrap_or(0.0);
                            let max = max.unwrap_or(1.0);
                            leaf_transmission_strength_field = Some(crate::gui_adjustables::FloatParam::new(*value, min..=max));
                        }
                    }
                    "leaves_bottom_color" => {
                        if let (GuiParamKind::Color, GuiParamValue::Color { value }) = (&param.kind, &param.value) {
                    ...
                    "terrain_soil_scale_voxels" => {
                        if let (GuiParamKind::Float, GuiParamValue::Float { value, min, max }) = (&param.kind, &param.value) {
                            let min = min.unwrap_or(0.0);
                            let max = max.unwrap_or(1.0);
                            terrain_soil_scale_voxels_field = Some(crate::gui_adjustables::FloatParam::new(*value, min..=max));
                        }
                    }
                    "terrain_soil_strength" => {
                        if let (GuiParamKind::Float, GuiParamValue::Float { value, min, max }) = (&param.kind, &param.value) {
                            let min = min.unwrap_or(0.0);
                            let max = max.unwrap_or(1.0);
                            terrain_soil_strength_field = Some(crate::gui_adjustables::FloatParam::new(*value, min..=max));
                        }
                    }
                    "terrain_rock_scale_voxels" => {
                        if let (GuiParamKind::Float, GuiParamValue::Float { value, min, max }) = (&param.kind, &param.value) {
                            let min = min.unwrap_or(0.0);
                            let max = max.unwrap_or(1.0);
                            terrain_rock_scale_voxels_field = Some(crate::gui_adjustables::FloatParam::new(*value, min..=max));
                        }
                    }
                    "terrain_rock_strength" => {
                        if let (GuiParamKind::Float, GuiParamValue::Float { value, min, max }) = (&param.kind, &param.value) {
                            let min = min.unwrap_or(0.0);
                            let max = max.unwrap_or(1.0);
                    ...
                    "terrain_rock_layer_tilt" => {
                        if let (GuiParamKind::Float, GuiParamValue::Float { value, min, max }) = (&param.kind, &param.value) {
                            let min = min.unwrap_or(0.0);
                            let max = max.unwrap_or(1.0);
                            terrain_rock_layer_tilt_field = Some(crate::gui_adjustables::FloatParam::new(*value, min..=max));
                        }
                    }
                    ...
                    "terrain_material_seed" => {
                        if let (GuiParamKind::Uint, GuiParamValue::Uint { value, min, max }) = (&param.kind, &param.value) {
                            let min = min.unwrap_or(0);
                            let max = max.unwrap_or(100);
                            terrain_material_seed_field = Some(crate::gui_adjustables::UintParam::new(*value, min..=max));
                        }
                    }
        ...
        GuiAdjustables {
            ...
            ddgi_history_retention: ddgi_history_retention_field.expect("Missing parameter: ddgi_history_retention"),
            ...
            kochia_color_a: kochia_color_a_field.expect("Missing parameter: kochia_color_a"),
            kochia_color_b: kochia_color_b_field.expect("Missing parameter: kochia_color_b"),
            kochia_bottom_diameter_voxels: kochia_bottom_diameter_voxels_field.expect("Missing parameter: kochia_bottom_diameter_voxels"),
            kochia_waist_diameter_voxels: kochia_waist_diameter_voxels_field.expect("Missing parameter: kochia_waist_diameter_voxels"),
            kochia_top_diameter_voxels: kochia_top_diameter_voxels_field.expect("Missing parameter: kochia_top_diameter_voxels"),
            kochia_waist_height: kochia_waist_height_field.expect("Missing parameter: kochia_waist_height"),
            ...
            terrain_soil_scale_voxels: terrain_soil_scale_voxels_field.expect("Missing parameter: terrain_soil_scale_voxels"),
            terrain_soil_strength: terrain_soil_strength_field.expect("Missing parameter: terrain_soil_strength"),
            terrain_rock_scale_voxels: terrain_rock_scale_voxels_field.expect("Missing parameter: terrain_rock_scale_voxels"),
            terrain_rock_strength: terrain_rock_strength_field.expect("Missing parameter: terrain_rock_strength"),
            terrain_rock_layer_tilt: terrain_rock_layer_tilt_field.expect("Missing parameter: terrain_rock_layer_tilt"),
...
pub fn get_float_param<'a>(adjustables: &'a crate::app::GuiAdjustables, id: &str) -> Option<&'a crate::gui_adjustables::FloatParam> {
    match id {
        ...
        "ddgi_history_retention" => Some(&adjustables.ddgi_history_retention),
        ...
        "kochia_bottom_diameter_voxels" => Some(&adjustables.kochia_bottom_diameter_voxels),
        "kochia_waist_diameter_voxels" => Some(&adjustables.kochia_waist_diameter_voxels),
        "kochia_top_diameter_voxels" => Some(&adjustables.kochia_top_diameter_voxels),
        "kochia_waist_height" => Some(&adjustables.kochia_waist_height),
        ...
        "terrain_soil_scale_voxels" => Some(&adjustables.terrain_soil_scale_voxels),
        "terrain_soil_strength" => Some(&adjustables.terrain_soil_strength),
        "terrain_rock_scale_voxels" => Some(&adjustables.terrain_rock_scale_voxels),
        "terrain_rock_strength" => Some(&adjustables.terrain_rock_strength),
        "terrain_rock_layer_tilt" => Some(&adjustables.terrain_rock_layer_tilt),
...
pub fn get_color_param<'a>(adjustables: &'a crate::app::GuiAdjustables, id: &str) -> Option<&'a crate::gui_adjustables::ColorParam> {
    match id {
        ...
        "kochia_color_a" => Some(&adjustables.kochia_color_a),
        "kochia_color_b" => Some(&adjustables.kochia_color_b),
...
pub fn get_float_param_mut<'a>(adjustables: &'a mut crate::app::GuiAdjustables, id: &str) -> Option<&'a mut crate::gui_adjustables::FloatParam> {
    match id {
        ...
        "ddgi_history_retention" => Some(&mut adjustables.ddgi_history_retention),
        ...
        "kochia_bottom_diameter_voxels" => Some(&mut adjustables.kochia_bottom_diameter_voxels),
        "kochia_waist_diameter_voxels" => Some(&mut adjustables.kochia_waist_diameter_voxels),
        "kochia_top_diameter_voxels" => Some(&mut adjustables.kochia_top_diameter_voxels),
        "kochia_waist_height" => Some(&mut adjustables.kochia_waist_height),
        ...
        "terrain_soil_scale_voxels" => Some(&mut adjustables.terrain_soil_scale_voxels),
        "terrain_soil_strength" => Some(&mut adjustables.terrain_soil_strength),
        "terrain_rock_scale_voxels" => Some(&mut adjustables.terrain_rock_scale_voxels),
        "terrain_rock_strength" => Some(&mut adjustables.terrain_rock_strength),
        "terrain_rock_layer_tilt" => Some(&mut adjustables.terrain_rock_layer_tilt),
...
pub fn get_color_param_mut<'a>(adjustables: &'a mut crate::app::GuiAdjustables, id: &str) -> Option<&'a mut crate::gui_adjustables::ColorParam> {
    match id {
        ...
        "kochia_color_a" => Some(&mut adjustables.kochia_color_a),
        "kochia_color_b" => Some(&mut adjustables.kochia_color_b),
