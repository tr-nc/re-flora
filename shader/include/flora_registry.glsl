...
const uint MAX_FLORA_SPECIES                 = 5;
const uint FLORA_SPECIES_COUNT               = 5;
...
const uint FLORA_SPECIES_KOCHIA      = 4;
// Render-only tree instance types; not included in FLORA_SPECIES_COUNT.
const uint FLORA_SPECIES_TREE_LEAF   = 5;
const uint FLORA_SPECIES_APPLE       = 6;
