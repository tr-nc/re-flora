...
void unpack_vertex_data(out vec3 o_voxel_pos, out uint o_vertex_offset, out float o_gradient,
                        uint packed_data) {
    o_voxel_pos = vec3(packed_data & 0xFF, (packed_data >> 8) & 0xFF, (packed_data >> 16) & 0xFF);
