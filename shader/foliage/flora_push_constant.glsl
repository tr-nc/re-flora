...
// Twelve rows provide height-based palettes for authored surface flora. Each
// row stores a precomputed linear RGB color packed as 10 bits/channel, so the
// vertex shader samples height color by table index instead of interpolating
// bottom/tip endpoints.
