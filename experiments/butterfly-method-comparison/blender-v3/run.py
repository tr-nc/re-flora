#!/usr/bin/env python3
"""Export saved v3 source. --rebuild explicitly replaces it from the recipe.
...
def assemble(draft):
    ...
    for i, size in enumerate((12, 16)):
        draw.text((8, i*530+8), f'V3 native {size}px - shared phase columns', fill='white')
    ...
    assert set(channels) == {('Flight pose', 'translation'), ('Flight pose', 'rotation'),
                             ...
                             ('Abdomen follow', 'rotation'), ('Abdomen tip follow', 'rotation')}
