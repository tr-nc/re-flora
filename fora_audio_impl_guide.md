...
External dependencies (suggested)

- symphonia (decode)
- cpal (playback)
- audionimbus (Steam Audio binding; or your own FFI wrapper)
- rubato or speexdsp (resampling) with a “resampler” feature; MVP can use linear interpolation
- crossbeam-channel (command/event channels) and/or atomic ring buffer
- glam (math: Vec3, Quat) or your own minimal types
- thiserror (errors), anyhow (examples)
